...
class LASegmenter:
    ...
    def define_regions(self):
        ...
        # POSTERIOR WALL: Rectangle between 4 PV ostia centers, ONLY on posterior side
        ...
        # Posterior border: plane at PV center perpendicular to AP axis (prevents extending anteriorly)
        # Points posterior to this plane have negative distance along ap_axis
        post_posterior_plane_pt = pv_center
        post_posterior_plane_normal = ap_axis
        ...
        dist_post_posterior = self.signed_distance_to_plane(self.points, post_posterior_plane_pt, post_posterior_plane_normal)
        ...
        # POSTERIOR WALL: Rectangle between 4 PV ostia centers, ONLY on posterior (rear) side
        post_mask = (unassigned &
                     ...
                     (dist_post_posterior < 0)) # Posterior side only (rear of heart)
        regions[post_mask] = 7
        unassigned = regions == 0
